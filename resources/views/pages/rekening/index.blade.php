    ...
    columns: [
      ...
      },
      {
        ...
        render: function(data){
          let DELETE_TRUCK_URL = "{{ route('rekening.delete.action', ':id') }}";
          let UPDATE_TRUCK_URL = "{{ route('rekening.update.view', ':id') }}";
          let DETAIL_TRUCK_URL = "{{ route('rekening.detail.view', ':id') }}";
